...
// MUST match FACILITIES_PER_SITEMAP in app/sitemap.ts. The child sitemaps at
// /sitemap/[id].xml are generated by sitemap.ts, which chunks facilities at
// 5000 per file. This index previously used 40000, so it only advertised
// sitemaps 0-2 while sitemap.ts actually produces 0-9. That hid ~23k valid
// facility URLs from Google. Keep these two constants in sync.
